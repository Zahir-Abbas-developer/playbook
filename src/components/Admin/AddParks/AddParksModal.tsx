...
function AddParksModal(props: any) {
...
const  options=[
  ...
  const onFinish = async (values: any) => {
    ...
    if (modalType !== "Add") {
      ...
      setDoc(doc(firestore, "parks", getTableRowValues?.id), updateProductValues)
      ...
      addDoc(collection(firestore, "parks"), addProductValues)
  ...
  return (
      ...
      <Form form={form} onFinish={onFinish} onFinishFailed={onFinishFailed}>
        <Row gutter={20} style={{ marginTop: "20px" }}>
          <Col lg={12} xs={24} style={{ marginBottom: "20px" }}>
            ...
            >
              <Input placeholder="Enter Park Name" id="parkName" style={{ marginTop: "2px", height: "40px" }} />
            </Form.Item>
          </Col>
          ...
          <Col lg={12} xs={24} style={{ marginBottom: "20px" }}>
            ...
            <Form.Item
              ...
              normalize={(value: any) => handleInputTrimStart(value)}
            >
              <Input placeholder="Enter Park Description" id="description" style={{ marginTop: "2px", height: "40px" }} />
            </Form.Item>
          </Col>
          <Col lg={12} xs={24} style={{ marginBottom: "20px" }}>
            ...
            <Form.Item
              ...
              normalize={(value: any) => handleInputTrimStart(value)}
            >
              <Select placeholder="Select Park Location" id="locationId" style={{ marginTop: "2px", height: "40px" }} options={locationOptions} />
            </Form.Item>
          </Col>
          ...
          <Col lg={12} xs={24} style={{ marginBottom: "20px" }}>
            ...
            // normalize={(value: any) => handleInputTrimStart(value)}
            >
              <InputNumber min={10} placeholder="Enter Park Price" id="price" style={{ marginTop: "2px", height: "40px", width: "100%" }} />
            </Form.Item>
          </Col>
          <Col lg={12} xs={24} style={{ marginBottom: "20px" }}>
            ...
            // normalize={(value: any) => handleInputTrimStart(value)}
            >
              <Input min={1} placeholder="Enter Park email" id="seats" style={{ marginTop: "2px", height: "40px", width: "100%" }} />
            </Form.Item>
          </Col>
          <Col lg={12} xs={24} style={{ marginBottom: "20px" }}>
    ...
    />
          ...
          <Col lg={12} xs={24} style={{ marginBottom: "20px" }}>
            ...
            // normalize={(value: any) => handleInputTrimStart(value)}
            >
              <InputNumber min={10} placeholder="Enter Park Phone" id="price" style={{ marginTop: "2px", height: "40px", width: "100%" }} />
            </Form.Item>
          </Col>
          {/* <Col xs={12} lg={12}>
