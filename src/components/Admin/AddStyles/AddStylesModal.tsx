...
import { usePostCategoriesMutation, usePostMaterialsMutation, useUpdateCategoriesMutation, useUpdateMaterialsMutation } from "../../../store/Slices/Products";


function AddStyleModal(props: any) {
  ...
  const [postMaterials, { isLoading: isPostJobRequestMutation }] = usePostMaterialsMutation();
  const [updateMaterials, { isLoading: isUpdateJobRequestMutation }] = useUpdateMaterialsMutation();
      ...
      <Form form={form} onFinish={onFinish} onFinishFailed={onFinishFailed}>
        <Row gutter={20} style={{ marginTop: "20px" }}>
          <Col lg={12} xs={24} style={{ marginBottom: "20px" }}>
            <label className="fs-14 fw-600">Material Name</label>
            <Form.Item
              name="name"
          ...
          <Col lg={12} xs={24} style={{ marginBottom: "20px" }}>
            <label className="fs-14 fw-600">Material Description</label>
            <Form.Item
              name="description"
              rules={[{ required: true, message: "Required field " }]}
              style={{ marginBottom: "8px" }}
